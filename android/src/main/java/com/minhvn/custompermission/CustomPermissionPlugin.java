...
public class CustomPermissionPlugin implements MethodCallHandler {
  ...
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "flutter.minhvn.com/permissions/methods");
    final CustomPermissionPlugin CustomPermissionPlugin = new CustomPermissionPlugin(registrar);
    channel.setMethodCallHandler(CustomPermissionPlugin);

    registrar.addRequestPermissionsResultListener(new PluginRegistry.RequestPermissionsResultListener() {
      @Override
      public boolean onRequestPermissionsResult(int id, String[] permissions, int[] grantResults) {
        if (id == PERMISSION_CODE) {
          CustomPermissionPlugin.handlePermissionsRequest(permissions, grantResults);
          return true;
        } else {
          return false;
        }
