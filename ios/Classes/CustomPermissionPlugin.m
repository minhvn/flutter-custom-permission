#import "CustomPermissionPlugin.h"


@implementation CustomPermissionPlugin {
...
+ (void)registerWithRegistrar:(NSObject <FlutterPluginRegistrar> *)registrar {
    FlutterMethodChannel *channel = [FlutterMethodChannel
                                     methodChannelWithName:@"flutter.minhvn.com/permissions/methods"
                                     binaryMessenger:[registrar messenger]];
    PermissionManager *permissionManager = [[PermissionManager alloc] initWithStrategyInstances];
    CustomPermissionPlugin *instance = [[CustomPermissionPlugin alloc] initWithPermissionManager:permissionManager];
