...
import 'package:custom_permission/src/permission_enums.dart';
import 'package:custom_permission/src/utils/codec.dart';

/// Provides a cross-platform (iOS, Android) API to request and check permissions.
class CustomPermission {
  factory CustomPermission() {
    if (_instance == null) {
      const MethodChannel methodChannel =
          MethodChannel('flutter.minhvn.com/permissions/methods');

      _instance = CustomPermission.private(methodChannel);
    }
    return _instance;
  }

  @visibleForTesting
  CustomPermission.private(this._methodChannel);

  static CustomPermission _instance;
