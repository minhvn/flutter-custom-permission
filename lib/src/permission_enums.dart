...
class PermissionGroup {
  ...
  /// Android: Phone
  /// iOS: Nothing
  static const PermissionGroup phone = PermissionGroup._(6);
  ...
  /// Android: Nothing
  /// iOS: Reminders
  static const PermissionGroup reminders = PermissionGroup._(8);

  /// Android: External Storage
  /// iOS: Nothing
  static const PermissionGroup storage = PermissionGroup._(9);
